...
namespace rfb {
  ...
  public:
    ...
    // approveConnection() is called some time after a
    // connectionRequested signal has been emitted, to accept or reject
    // the connection. The accept argument should be true for
    // acceptance, or false for rejection, in which case a string reason
    // may also be given.
    ...
    // connectionRequested is emitted when a connection has been
    ...
    core::signal<SConnection*> connectionRequested;
