...
namespace rfb {
  ...
  public:
    ...
    void writeLosslessRefresh(const core::Region& req, const PixelBuffer* pb,
                              const RenderedCursor* renderedCursor,
  ...
  protected:
    ...
    core::Region getLosslessRefresh(const core::Region& req, size_t maxUpdateSize);
    ...
    void writeCopyRects(const core::Region& copied, const core::Point& delta);
    ...
    bool checkSolidTile(const core::Rect& r, const uint8_t* colourValue,
                        const PixelBuffer *pb);
    void extendSolidAreaByBlock(const core::Rect& r, const uint8_t* colourValue,
                                const PixelBuffer *pb, core::Rect* er);
    void extendSolidAreaByPixel(const core::Rect& r, const core::Rect& sr,
  ...
  protected:
    ...
    template<class T>
    inline bool checkSolidTile(const core::Rect& r, const T,
                               const PixelBuffer *pb);
    template<class T>
