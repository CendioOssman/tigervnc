...
void CConnection::clipboardCaps(uint32_t flags, const uint32_t* lengths)
{
  uint32_t sizes[] = { 0 };
...
void CConnection::clipboardRequest(uint32_t flags)
{
...
void CConnection::clipboardProvide(uint32_t flags,
