...
namespace core {
  ...
  public:
    ...
    // signal arguments must be convertible to how the signal is
    ...
    template<class S, class T, typename... SigArgs, typename... Args>
    void disconnectSignal(const signal<SigArgs...> S::* signal,
                          T* obj, void (T::*callback)(Args...));
  ...
  protected:
    ...
    // signal. Inclusion of signal arguments must be convertible to
