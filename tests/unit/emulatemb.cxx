...
{
public:
  void sendPointerEvent(const core::Point& pos, uint8_t buttonMask) override;

  struct PointerEventParams {core::Point pos; uint8_t mask; };

  std::vector<PointerEventParams> results;
};

void TestClass::sendPointerEvent(const core::Point& pos, uint8_t buttonMask)
{
...
void testDisabledOption()
{
  ...
  test.filterPointerEvent(core::Point(0, 10), left);
...
void testLeftClick()
{
  ...
  test.filterPointerEvent(core::Point(0, 0), empty);
...
void testNormalMiddlePress()
{
  ...
  emulateMiddleButton.setParam(true);
  test.filterPointerEvent(core::Point(0, 0), middle);
...
void testEmulateMiddleMouseButton()
{
  ...
  emulateMiddleButton.setParam(true);
  test.filterPointerEvent(core::Point(20, 30), right);
  test.filterPointerEvent(core::Point(20, 30), both);
...
void testLeftReleaseAfterEmulate()
{
  ...
  emulateMiddleButton.setParam(true);
  test.filterPointerEvent(core::Point(20, 30), left);
  test.filterPointerEvent(core::Point(20, 30), both);
  test.filterPointerEvent(core::Point(20, 30), right); // left released
...
void testRightReleaseAfterEmulate()
{
  ...
  test.filterPointerEvent(core::Point(20, 30), right);
  test.filterPointerEvent(core::Point(20, 30), both);
  test.filterPointerEvent(core::Point(20, 30), left); // right released
...
void testDragAndRelease()
{
  ...
  emulateMiddleButton.setParam(true);
  test.filterPointerEvent(core::Point(10, 10), left);
  test.filterPointerEvent(core::Point(20, 20), empty);
