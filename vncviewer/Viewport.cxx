    ...
    menuCtrlKey(false), menuAltKey(false), cursor(nullptr)
{
  ...
  setCursor(0, 0, core::Point(0, 0), nullptr);
}
...
void Viewport::sendPointerEvent(const core::Point& pos, uint8_t buttonMask)
{
  if (viewOnly)
      return;
...
void Viewport::handlePointerEvent(const core::Point& pos, uint8_t buttonMask)
{
