...
[ -x /usr/sbin/selinuxenabled ] && /usr/sbin/selinuxenabled && chcon -Rt svirt_sandbox_file_t ${CURDIR}/build

## Copy over the source code

git archive --prefix tigervnc-${VERSION}/ HEAD | xz > ${CURDIR}/build/tigervnc_${VERSION}.orig.tar.xz
