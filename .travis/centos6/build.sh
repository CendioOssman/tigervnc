...
[ -x /usr/sbin/selinuxenabled ] && /usr/sbin/selinuxenabled && chcon -Rt svirt_sandbox_file_t ${CURDIR}/rpmbuild
...
curl -L -o ${CURDIR}/rpmbuild/SOURCES/fltk-1.3.4-1-source.tar.gz https://www.fltk.org/pub/fltk/1.3.4/fltk-1.3.4-1-source.tar.gz
...
git archive --prefix tigervnc-${VERSION}/ HEAD | bzip2 > ${CURDIR}/rpmbuild/SOURCES/tigervnc-${VERSION}.tar.bz2
